 ...
 * Generating 1m rows: ~130 seconds on a 2.3 GHz i7 with a local MySQL 5.7 with indicies, ~90s without
 * /top_urls: 3.1s first load (2.5 SQL, 0.6 JSON serialization), 0.6s cached load
 * /top_referrers: 2.9s first load (2.9 SQL, 0.0 JSON serialization), 0.005s cached load
